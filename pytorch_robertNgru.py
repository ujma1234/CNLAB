# KLUE-RoBERTa-base
# 참고 링크 https://dacon.io/en/codeshare/3039
...
from my_module import ps_bertNgru
...
model = ps_bertNgru.GRUBERT(hidden_size = 768, fc_size = 2048, num_layers=1, bertmodel = bertmodel, dr_rate = dr_rates, bert_type=1).to(device)
...
for epoch in range(num_epochs):
    ...
    #             "cost":cost,
    #             "description":f"RoBERTa-GRU 체크포인트-{checkpoint}",
    #         },
    #         f".cache/robertNgru-{checkpoint}.pt",
    #     )
    #     checkpoint += 1